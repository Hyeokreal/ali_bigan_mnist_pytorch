...
class P(nn.Module):
    def __init__(self, d=16):
        ...
        self.deconv2 = nn.ConvTranspose2d(z_dim, d * 4, 4, 4, 0)
        self.deconv2_bn = nn.BatchNorm2d(d * 4)
        self.deconv3 = nn.ConvTranspose2d(d * 4, d * 2, 4, 4, 0)
    ...
    def forward(self, z):
        ...
        out = F.leaky_relu(self.deconv2_bn(self.deconv2(z)))
        # print("p shape ", out.size())
...
class Q(nn.Module):
    def __init__(self, d=16):
        ...
        self.conv1 = nn.Conv2d(1, d * 4, 4, 4, 1)
